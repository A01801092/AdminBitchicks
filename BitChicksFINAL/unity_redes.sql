...
('Valentina', 'Morales', '2004-05-30', TIMESTAMPDIFF(YEAR, '2004-05-30', CURDATE()), 'México', 'valentina.morales@gmail.com', 'valen123', 'Femenino', 120, 2, 4, 6, '2025-04-10 09:00:00', '2025-04-10 11:00:00', 2.0, FALSE),
('Sebastián', 'Pérez', '2003-08-22', TIMESTAMPDIFF(YEAR, '2003-08-22', CURDATE()), 'Argentina', 'sebasperez@gmail.com', 'sebas456', 'Masculino', 60, 1, 2, 1, '2025-04-09 13:00:00', '2025-04-09 14:30:00', 1.5, FALSE),
('Lucía', 'Martínez', '2005-02-14', TIMESTAMPDIFF(YEAR, '2005-02-14', CURDATE()), 'Chile', 'luciamtz@gmail.com', 'lucia789', 'Femenino', 180, 3, 6, 8, '2025-04-08 08:00:00', '2025-04-08 10:45:00', 2.75, FALSE),
('Julián', 'Castro', '2006-10-05', TIMESTAMPDIFF(YEAR, '2006-10-05', CURDATE()), 'Perú', 'jcastro@gmail.com', 'julian2025', 'Masculino', 90, 2, 3, 2, '2025-04-07 17:00:00', '2025-04-07 18:30:00', 1.5, FALSE),
('Renata', 'Suárez', '2003-01-17', TIMESTAMPDIFF(YEAR, '2003-01-17', CURDATE()), 'Colombia', 'renasuarez@gmail.com', 'rena321', 'Femenino', 130, 4, 2, 5, '2025-04-06 15:30:00', '2025-04-06 17:45:00', 2.25, FALSE),
('Andrés', 'Paredes', '2005-02-14', TIMESTAMPDIFF(YEAR, '2005-02-14', CURDATE()), 'Chile', 'andres.paredes@mail.com', 'andres123', 'Masculino', 300, 5, 4, 8, '2025-04-15 08:00:00', '2025-04-15 10:00:00', 2.0, FALSE),
('Camila', 'Soto', '2004-07-09', TIMESTAMPDIFF(YEAR, '2004-07-09', CURDATE()), 'Perú', 'camila.soto@mail.com', 'cami456', 'Femenino', 275, 3, 5, 10, '2025-04-14 12:00:00', '2025-04-14 14:00:00', 2.0, FALSE),
('Diego', 'Araya', '2003-10-11', TIMESTAMPDIFF(YEAR, '2003-10-11', CURDATE()), 'Argentina', 'diego.araya@mail.com', 'diego789', 'Masculino', 320, 6, 4, 7, '2025-04-13 16:00:00', '2025-04-13 17:30:00', 1.5, FALSE),
('Fernanda', 'Ríos', '2002-03-25', TIMESTAMPDIFF(YEAR, '2002-03-25', CURDATE()), 'Colombia', 'fer.rios@mail.com', 'ferpass', 'Femenino', 190, 2, 2, 3, '2025-04-12 10:00:00', '2025-04-12 11:30:00', 1.5, FALSE),
('Tomás', 'Herrera', '2005-11-01', TIMESTAMPDIFF(YEAR, '2005-11-01', CURDATE()), 'México', 'tomas.herrera@mail.com', 'tompass', 'Masculino', 280, 3, 3, 6, '2025-04-11 09:00:00', '2025-04-11 10:30:00', 1.5, FALSE),
('Isidora', 'Navarrete', '2004-04-30', TIMESTAMPDIFF(YEAR, '2004-04-30', CURDATE()), 'Chile', 'isi.nav@mail.com', 'isidora789', 'Femenino', 230, 4, 3, 7, '2025-04-10 11:00:00', '2025-04-10 12:00:00', 1.0, FALSE),
('Martín', 'Castro', '2003-06-15', TIMESTAMPDIFF(YEAR, '2003-06-15', CURDATE()), 'Ecuador', 'martin.castro@mail.com', 'martin123', 'Masculino', 260, 2, 5, 4, '2025-04-09 08:30:00', '2025-04-09 09:30:00', 1.0, FALSE),
('Josefa', 'Gallardo', '2006-01-10', TIMESTAMPDIFF(YEAR, '2006-01-10', CURDATE()), 'Paraguay', 'josefa.gallardo@mail.com', 'josefa456', 'Femenino', 210, 3, 2, 5, '2025-04-08 14:00:00', '2025-04-08 15:00:00', 1.0, FALSE),
('Cristóbal', 'Pino', '2004-08-20', TIMESTAMPDIFF(YEAR, '2004-08-20', CURDATE()), 'Chile', 'cristobal.pino@mail.com', 'crispin123', 'Masculino', 310, 4, 4, 9, '2025-04-07 10:00:00', '2025-04-07 12:00:00', 2.0, FALSE),
('Renata', 'Lagos', '2005-12-18', TIMESTAMPDIFF(YEAR, '2005-12-18', CURDATE()), 'Uruguay', 'renata.lagos@mail.com', 'renata2025', 'Femenino', 280, 3, 5, 6, '2025-04-06 13:00:00', '2025-04-06 15:00:00', 2.0, FALSE),
('Matías', 'Guzmán', '2003-05-05', TIMESTAMPDIFF(YEAR, '2003-05-05', CURDATE()), 'Chile', 'matias.guzman@mail.com', 'mati123', 'Masculino', 300, 5, 3, 7, '2025-04-05 08:00:00', '2025-04-05 10:00:00', 2.0, FALSE),
('Antonia', 'Salazar', '2004-02-07', TIMESTAMPDIFF(YEAR, '2004-02-07', CURDATE()), 'Argentina', 'antonia.salazar@mail.com', 'anto456', 'Femenino', 270, 2, 2, 5, '2025-04-04 09:30:00', '2025-04-04 11:00:00', 1.5, FALSE),
('Gabriel', 'Campos', '2005-09-30', TIMESTAMPDIFF(YEAR, '2005-09-30', CURDATE()), 'Colombia', 'gabriel.campos@mail.com', 'gabpass', 'Masculino', 250, 1, 3, 4, '2025-04-03 14:00:00', '2025-04-03 15:30:00', 1.5, FALSE),
('Trinidad', 'Alarcón', '2002-06-02', TIMESTAMPDIFF(YEAR, '2002-06-02', CURDATE()), 'Chile', 'trini.alarcon@mail.com', 'trini123', 'Femenino', 300, 4, 4, 8, '2025-04-02 10:00:00', '2025-04-02 12:00:00', 2.0, FALSE),
('Joaquín', 'Bravo', '2003-07-22', TIMESTAMPDIFF(YEAR, '2003-07-22', CURDATE()), 'Perú', 'joaquin.bravo@mail.com', 'joa123', 'Masculino', 275, 2, 2, 5, '2025-04-01 13:00:00', '2025-04-01 14:30:00', 1.5, FALSE),
('Daniela', 'León', '2006-03-17', TIMESTAMPDIFF(YEAR, '2006-03-17', CURDATE()), 'Bolivia', 'daniela.leon@mail.com', 'dani456', 'Femenino', 260, 3, 3, 6, '2025-03-31 11:00:00', '2025-03-31 12:30:00', 1.5, FALSE),
('Nicolás', 'Silva', '2004-11-06', TIMESTAMPDIFF(YEAR, '2004-11-06', CURDATE()), 'Chile', 'nico.silva@mail.com', 'nicosilva', 'Masculino', 310, 5, 4, 7, '2025-03-30 09:00:00', '2025-03-30 11:00:00', 2.0, FALSE),
('Paula', 'Figueroa', '2005-08-14', TIMESTAMPDIFF(YEAR, '2005-08-14', CURDATE()), 'Paraguay', 'paula.figueroa@mail.com', 'paula2025', 'Femenino', 290, 2, 2, 6, '2025-03-29 10:30:00', '2025-03-29 12:00:00', 1.5, FALSE),
('Ignacio', 'Saavedra', '2003-01-25', TIMESTAMPDIFF(YEAR, '2003-01-25', CURDATE()), 'México', 'ignacio.saavedra@mail.com', 'ignapass', 'Masculino', 200, 1, 3, 3, '2025-03-28 08:00:00', '2025-03-28 09:30:00', 1.5, FALSE),
('Constanza', 'Peña', '2006-12-02', TIMESTAMPDIFF(YEAR, '2006-12-02', CURDATE()), 'Chile', 'constanza.pena@mail.com', 'conni456', 'Femenino', 240, 3, 4, 5, '2025-03-27 10:00:00', '2025-03-27 11:30:00', 1.5, FALSE);
...
('Max', 20, 80, 60, 4, 'valentina.morales@gmail.com', '2025-04-10 08:30:00', '2025-04-10 10:00:00'),
('Luna', 15, 85, 65, 3, 'sebasperez@gmail.com', '2025-04-09 12:00:00', '2025-04-09 14:00:00'),
('Toby', 30, 70, 50, 2, 'luciamtz@gmail.com', '2025-04-08 07:45:00', '2025-04-08 09:30:00'),
('Nina', 10, 95, 80, 5, 'jcastro@gmail.com', '2025-04-07 16:30:00', '2025-04-07 18:00:00'),
('Rocky', 25, 60, 55, 3, 'renasuarez@gmail.com', '2025-04-06 15:00:00', '2025-04-06 17:00:00'),
('Bolt', 10, 90, 80, 5, 'andres.paredes@mail.com', '2025-04-15 07:30:00', '2025-04-15 09:30:00'),
('Miel', 20, 75, 65, 4, 'camila.soto@mail.com', '2025-04-14 11:00:00', '2025-04-14 13:00:00'),
('Zeus', 15, 85, 70, 5, 'diego.araya@mail.com', '2025-04-13 15:00:00', '2025-04-13 16:30:00'),
('Canela', 25, 60, 55, 3, 'fer.rios@mail.com', '2025-04-12 09:00:00', '2025-04-12 10:00:00'),
('Simba', 18, 80, 75, 4, 'tomas.herrera@mail.com', '2025-04-11 08:00:00', '2025-04-11 09:30:00'),
('Nina', 12, 88, 78, 5, 'isi.nav@mail.com', '2025-04-10 10:00:00', '2025-04-10 11:00:00'),
('Rocky', 20, 70, 60, 3, 'martin.castro@mail.com', '2025-04-09 07:30:00', '2025-04-09 08:30:00'),
('Lola', 16, 82, 72, 4, 'josefa.gallardo@mail.com', '2025-04-08 13:00:00', '2025-04-08 14:00:00'),
('Max', 14, 85, 80, 5, 'cristobal.pino@mail.com', '2025-04-07 09:00:00', '2025-04-07 11:00:00'),
('Coco', 22, 65, 60, 3, 'renata.lagos@mail.com', '2025-04-06 12:00:00', '2025-04-06 14:00:00'),
('Bella', 19, 78, 70, 4, 'matias.guzman@mail.com', '2025-04-05 07:00:00', '2025-04-05 09:00:00'),
('Toby', 21, 73, 68, 3, 'antonia.salazar@mail.com', '2025-04-04 08:30:00', '2025-04-04 10:30:00'),
('Milo', 13, 89, 77, 5, 'gabriel.campos@mail.com', '2025-04-03 13:00:00', '2025-04-03 14:30:00'),
('Kiara', 17, 80, 75, 4, 'trini.alarcon@mail.com', '2025-04-02 09:00:00', '2025-04-02 11:00:00'),
('Jack', 24, 60, 58, 2, 'joaquin.bravo@mail.com', '2025-04-01 12:00:00', '2025-04-01 14:00:00'),
('Nube', 11, 92, 83, 5, 'daniela.leon@mail.com', '2025-03-31 10:00:00', '2025-03-31 11:30:00'),
('Firu', 20, 75, 65, 4, 'nico.silva@mail.com', '2025-03-30 08:00:00', '2025-03-30 10:00:00'),
('Daisy', 13, 88, 78, 5, 'paula.figueroa@mail.com', '2025-03-29 09:30:00', '2025-03-29 11:00:00'),
('Tigre', 16, 80, 70, 4, 'ignacio.saavedra@mail.com', '2025-03-28 07:30:00', '2025-03-28 09:00:00'),
('Luna', 18, 85, 76, 5, 'constanza.pena@mail.com', '2025-03-27 09:00:00', '2025-03-27 10:30:00');
...
('emanuelhdz01@gmail.com', 3, 3),

('andrea@gmail.com', 1, 4),
('andrea@gmail.com', 3, 2),

('luisr@gmail.com', 1, 1),
('luisr@gmail.com', 2, 1),

('camitorres@gmail.com', 2, 3),
('camitorres@gmail.com', 3, 2),

('mateolopez@gmail.com', 1, 2),
('mateolopez@gmail.com', 3, 1),

('isagomez@gmail.com', 1, 1),

('diegof@gmail.com', 1, 2),
('diegof@gmail.com', 2, 2),
('diegof@gmail.com', 3, 1),

('valentina.morales@gmail.com', 1, 3),
('valentina.morales@gmail.com', 2, 2),

('sebasperez@gmail.com', 2, 1),

('luciamtz@gmail.com', 1, 3),
('luciamtz@gmail.com', 3, 4),

('jcastro@gmail.com', 1, 2),
('jcastro@gmail.com', 2, 1),

('renasuarez@gmail.com', 1, 2),
('renasuarez@gmail.com', 3, 2),

('andres.paredes@mail.com', 1, 4),
('andres.paredes@mail.com', 2, 3),
('andres.paredes@mail.com', 3, 4),

('camila.soto@mail.com', 1, 3),
('camila.soto@mail.com', 3, 2),

('diego.araya@mail.com', 2, 1),
('diego.araya@mail.com', 3, 3);
...
BEGIN
    SELECT monedas, cantidadJuguete, cantidadComida, rachaDias, nuevoUsuario
    FROM usuario
    WHERE correo_jugador = p_correo;
END$$
...
CREATE TRIGGER asignar_mascota_predeterminada
